...
var appiframe_tpl = '<iframe style="width:100%;height:  90vh;" frameborder="0" class="appiframe"></iframe>';

function openapp(url, appId, appname, refresh) {
	$("#subnav").html(appname);	
	$(".navlist_ul").find("li").removeClass("xxmt_sidebar_sele");
	$(".navlist_ul").find("#"+appId).addClass("xxmt_sidebar_sele");
